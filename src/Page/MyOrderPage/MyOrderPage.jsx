  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const tablesResponse = await fetch('https://efficiently-leads-table-august.trycloudflare.com/api/tables/');
        ...
        const ordersResponse = await fetch('https://efficiently-leads-table-august.trycloudflare.com/api/baskets/');
